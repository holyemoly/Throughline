export function buildSystemPrompt({ datetime, recentDiary = null, memoriesText = null, spotifyData = null, calendarData = null, healthData = null, projectContext = null, mode = 'conversation' }) {
...
Current date and time: ${datetime}${modeNote}${diarySection}${memoriesSection}${projectSection}${spotifySection}${calendarSection}${healthSection}`;
}
