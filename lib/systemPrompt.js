export function buildSystemPrompt({ datetime, recentDiary = null, spotifyData = null, calendarData = null, healthData = null }) {
...
Current date and time: ${datetime}${diarySection}${spotifySection}${calendarSection}${healthSection}`;
}
